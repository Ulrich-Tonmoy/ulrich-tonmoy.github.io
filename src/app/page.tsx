...
export default function Home() {
  return (
    <main className="h-screen w-screen flex justify-center items-center bg-black gap-2 flex-wrap flex-col">
      <span className="bg-slate-700 text-white p-2 rounded hover:bg-slate-600">
        Choose your viewer
      </span>
      <div className="flex justify-center items-center gap-2 flex-wrap">
        <Link
          href="/portfolio/vs-code"
